...
int main(int argc, char *argv[]) {
    ...
    if (strcmp(argv[1], "-c") == 0) {
        ...
        int start = atoi(argv[2]) - 1; // Convert start position from string to int.
        int end = atoi(argv[3]) - 1;   // Convert end position from string to int.
    ...
    // Handling the -f flag for fields.
        ...
        int field = atoi(argv[3]) - 1;  // Convert field number from string to int.
